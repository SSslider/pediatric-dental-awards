      ...
      <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-secondary">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground leading-relaxed">
          <p className="lead text-xl text-foreground font-medium mb-6">
            מרפאת ד״ר יעל פרונט רואה חשיבות עליונה בהענקת שירות שוויוני לכלל הלקוחות והגולשים, לרבות אנשים עם מוגבלות. אנו פועלים רבות להנגשת המרפאה הפיזית ואתר האינטרנט שלנו כחלק מעקרונות השירות והאחריות החברתית שאנו דוגלים בהם, בהתאם לחוק שוויון זכויות לאנשים עם מוגבלות, תשנ"ח-1998 והתקנות על פיו.
          </p>
          ...
          <div className="bg-secondary/20 p-6 rounded-2xl mt-4 space-y-2 text-foreground font-medium">
            <p>שם רכזת הנגישות: ד״ר יעל פרונט</p>
            <p>טלפון מרפאה: 04-8344034 | ווטסאפ: 050-9344035</p>
            <p>דוא"ל: drfront.yael@gmail.com</p>
            <p>כתובת המרפאה: שד׳ מוריה 64, חיפה</p>
          </div>
